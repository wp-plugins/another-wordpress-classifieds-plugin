...
<p>
    <label for="<?php echo esc_attr( $this->get_field_id( 'subtitle' ) ); ?>"><?php _e('Subtitle:', 'AWPCP'); ?></label>
...
<p>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_keyword' ) ); ?>"><?php _e('Show keyword field?', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_by' ) ); ?>"><?php _e('Show Posted By field?', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_city' ) ); ?>"><?php _e('Show City field?', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_state' ) ); ?>"><?php _e('Show State field?', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_country' ) ); ?>"><?php _e('Show Country field?', 'AWPCP'); ?></label>
    <br/>
    ...
    <label for="<?php echo esc_attr( $this->get_field_id( 'show_category' ) ); ?>"><?php _e('Show Category field?', 'AWPCP'); ?></label>
</p>
