...
<p><label for="<?php echo $this->get_field_id('show_keyword'); ?>"><?php _e('Show keyword field?'); ?>
<input class="widefat"
...
<p><label for="<?php echo $this->get_field_id('show_by'); ?>"><?php _e('Show Posted By field?'); ?>
<input class="widefat"
...
<p><label for="<?php echo $this->get_field_id('show_city'); ?>"><?php _e('Show City field?'); ?>
<input class="widefat"
...
<p><label for="<?php echo $this->get_field_id('show_state'); ?>"><?php _e('Show State field?'); ?>
<input class="widefat"
...
<p><label for="<?php echo $this->get_field_id('show_country'); ?>"><?php _e('Show Country field?'); ?>
<input class="widefat"
